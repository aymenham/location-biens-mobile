...
public class MaisonAdapter extends RecyclerView.Adapter<MaisonAdapter.SearchHolder> {

    private Context context ;

    private List<Maison> bienList ;

    public MaisonAdapter(Context context, List<Maison> bienList) {
    ...
    public void onBindViewHolder(SearchHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString(Config.TYPE , "maison");
                ...
                bundle.putBoolean(Config.KEY_JARDIN_MAISON , bienList.get(position).isJardin());
                bundle.putBoolean(Config.KEY_PISCINE_MAISON , bienList.get(position).isPiscine());
                bundle.putBoolean(Config.KEY_GARAGE_MAISON , bienList.get(position).isGarage());
