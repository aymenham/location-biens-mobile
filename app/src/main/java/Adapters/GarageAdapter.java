...
public class GarageAdapter extends RecyclerView.Adapter<GarageAdapter.GarageHolder> {
    ...
    public GarageAdapter(List<Bien> bienList, Context context) {
        this.bienList = bienList;
        this.context = context;
    }

    @Override
    public GarageHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.recherche_row , parent , false);

        return new GarageHolder(view);
    }

    @Override
    public void onBindViewHolder(GarageHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString(Config.TYPE , "garage");
    ...
    public class GarageHolder extends RecyclerView.ViewHolder{
