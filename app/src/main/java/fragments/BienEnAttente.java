 ...
 */
public class BienEnAttente extends Fragment {
    private View view ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_bien_en_attente, container, false);
        initViews();
        getAllInforations();
        return view;
    }
    ...
    private void initViews(){
        ...
        recyclerView = view.findViewById(R.id.recyler_bien_enattent);
        listVide = view.findViewById(R.id.list_vide_bien_en_attente);
        bienList = new ArrayList<>();
        sessionManager = new SessionManager(getActivity());
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView.setHasFixedSize(true);
        adapter = new BienARadapter(bienList , getActivity() , "A");
    ...
    private void getAllInforations(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.BIEN_EN_ATTENTE, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(adapter.getItemCount()==0){
                        ...
                        listVide.setText("PAS DE BIEN EN ATTENTE D'ACCEPTATION");
