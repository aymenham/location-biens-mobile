 ...
 */
public class ReservationRefuser extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_reservation_refuser, container, false);
        initViews();
        getAllInformations();
        return view;
    }
    ...
    private void initViews(){
        ...
        recyclerView = view.findViewById(R.id.recyler_reservation_refuser);
        listVide = view.findViewById(R.id.list_vide_reservation_refuser);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setHasFixedSize(true);
        sessionManager = new SessionManager(getActivity());
        list = new ArrayList<>();
        adapter = new MesReservationAdapter(list , getContext() , "R");
