 ...
 */
public class ReservationAccepter extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_reservation_accepter, container, false);
        initViews();
        getAllInformations();
        return view ;
    }
    ...
    private void initViews(){
        ...
        recyclerView = view.findViewById(R.id.recyler_reservation_accepter);
        listVide = view.findViewById(R.id.list_vide_reservation_accepter);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setHasFixedSize(true);
        sessionManager = new SessionManager(getActivity());
        list = new ArrayList<>();
        adapter = new MesReservationAdapter(list , getContext() , "A");
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(adapter.getItemCount()==0){
                        ...
                        listVide.setText("PAS DE BIEN ACCEPTE ");
