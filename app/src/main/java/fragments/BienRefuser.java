 ...
 */
public class BienRefuser extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_bien_refuser, container, false);
        initViews();
        getAllInforations();
        return view;
    }
    ...
    private void initViews(){
        ...
        recyclerView = view.findViewById(R.id.recyler_bien_refuser);
        listVide = view.findViewById(R.id.list_vide_bien_refuser);
        bienList = new ArrayList<>();
        sessionManager = new SessionManager(getActivity());
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView.setHasFixedSize(true);
        adapter = new BienARadapter(bienList , getActivity() , "R");
    ...
    private void getAllInforations(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.BIEN_REFUSER, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(adapter.getItemCount()==0){
                        ...
                        listVide.setText("PAS DE BIEN REFUSE");
